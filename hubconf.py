...
def custom(path='C:/Users/FineTiger/PycharmProjects/flowerProject1/ml/best.pt', autoshape=True, verbose=True, device=None):
...
if __name__ == '__main__':
    ...
    model = custom(path='/ml/best.pt')  # custom
